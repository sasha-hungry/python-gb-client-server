...
class Tests(unittest.TestCase):
    ...
    def test_default_get_address_port(self):
        """ 
        Тестирует формирование ipv4 адреса и порта по умолчанию
        """
        ipv4_port_default = [ '', 7777]
        
        test_ipv4_port = get_address_port()
        self.assertEqual(test_ipv4_port,ipv4_port_default)
