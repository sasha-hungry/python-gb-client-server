...
def get_address_port():
    ...
    try:
        ...
        client_logger.info('не указан обязательный параметр после -p')
        #print('После параметра -\'p\' необходимо указать номер порта.')
        sys.exit(1)
    except ValueError:
        client_logger.error('В качастве порта может быть указано только число в диапазоне от 1024 до 65535.')
    ...
    try:
        ...
        client_logger.error('не указан обязательный параметр после -a')
        sys.exit(1)
